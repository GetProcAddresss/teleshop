...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "admin.goods.add.prompt.image": "📸 Отправьте изображение для товара (фото).\nИли отправьте /skip, чтобы пропустить.",
        "admin.goods.add.image.saved": "✅ Изображение сохранено.",
        "admin.goods.add.image.invalid": "❌ Не удалось обработать изображение. Попробуйте ещё раз или /skip.",
    ...
    "en": {
        ...
        "admin.goods.add.prompt.image": "📸 Send a product image (photo).\nOr send /skip to skip.",
        "admin.goods.add.image.saved": "✅ Image saved.",
        "admin.goods.add.image.invalid": "❌ Couldn't process image. Try again or /skip.",
